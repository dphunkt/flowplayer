...
package org.flowplayer.model {
	...
	public class Clip extends ClipEventDispatcher implements Extendable {
		...
		private var _seekToOnStart:Number = 0;
...
//		}
		...
		public function set scaling(scaling:MediaSize):void {
			...
			log.debug("scaling : " + scaling + ", dispatching update");
...
//				log.warn("Getting height from a clip that does not have content loaded yet, returning zero");
		...
		public function set i(iv:String):void {
			_i = iv;
		}
		...
		public function set c(cipher:String):void {
			_c = cipher;
		}
		...
		public function set tags(tags:Object):void {
			_tags = tags;
			if (_playlist) {
				log.debug('set tags, dispatching update', _tags);
				this.dispatch(ClipEventType.UPDATE, _tags);
			}
		}
		
		[Value]		
		public function get seekToOnStart():Number {
			return _seekToOnStart;
		}
		
		public function set seekToOnStart(seekToOnStart:Number):void {
			_seekToOnStart = seekToOnStart;
		}		
